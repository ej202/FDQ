...
if (trim($cod01) != "") :
    ...
    if (trim($cod02) != "") :
        ...
        if (isset($_REQUEST['btnEditContent'])) :
            ...
            $err = fdq_ms_content_edit_func($fv_title, $fv_icon, $fv_video_title, $fv_video_url, $fv_audio_title, $fv_audio_url, $fv_audio_url_male, $fv_audio_url_female, $fv_day, $fv_redir_url, $fv_active, $cod01, $cod02);
            ...
            if (trim($cod02) != "") :
                ...
                $fv_audio_url_male= $rs01[0]['audio_url_male'];;
                $fv_audio_url_female= $rs01[0]['audio_url_female'];;
    ...
    <?php if (trim($cod02) != "") : ?>
        <div class="mscm_main_wrapper">
            <?php if ($success_msg == "") : ?>
                ...
                <div class="mscm_page_title">Edit course content</div>
                <form name="recipe_add_form" id="recipe_add_form" action="<?php echo $pageUrl; ?>" method="post">
                    ...
                    <div class="mscm_row">
                        ...
                        <input type="radio" name="fv_active" id="fv_active1" value="1" <?php if ($fv_active == '1') {
                                                                                            echo 'checked="checked"';
                                                                                        } ?>> <label for="fv_active1"><strong>Active</strong></label>
                        <input type="radio" name="fv_active" id="fv_active0" value="0" style="margin:0 0 0 10px" <?php if ($fv_active == '0') {
                                                                                                                        echo 'checked="checked"';
                                                                                                                    } ?>> <label for="fv_active0"><strong>Inactive</strong></label>
                    </div>
